 ...
 * </ul>
 *
 * Distributed-trace correlation is handled by Micrometer Tracing (Brave) on the classpath — {@code
 * traceId} / {@code spanId} are pushed into MDC automatically, which is what {@code
 * ApiResponse.currentTraceId()} reads.
 */
@AutoConfiguration
